...
func Upper(args []tokens.Token, ctx context.Context) (tokens.Token, error) {
	return lowerUpper(strings.ToUpper, args, ctx)
}

func Lower(args []tokens.Token, ctx context.Context) (tokens.Token, error) {
...
func Caps(args []tokens.Token, ctx context.Context) (tokens.Token, error) {
	if len(args) != 1 {
