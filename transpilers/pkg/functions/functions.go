...
type PreEvalFunction func(args []tokens.Token, ctx context.Context) (tokens.Token, error)

var preEval = map[string]PreEvalFunction{
	"add":               Add,
	"caps":              Caps,
	"ceil":              Ceil,
	"contains":          Contains,
...
type PostEvalFunction func(scope tokens.Scope, args []tokens.Token, ctx context.Context) (tokens.Token, error)

var postEval = map[string]PostEvalFunction{
	"and":      And,
	"eval":     EvalFun,
	"filter":   Filter,
	"function": NewFun,
