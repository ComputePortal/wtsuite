...
func (t *Continue) WriteStatement(indent string) string {
	var b strings.Builder
...
func (t *Continue) HoistValues(stack values.Stack) error {
	return nil
}

func (t *Continue) EvalStatement(stack values.Stack) error {
	return nil
}
